...
import { updateLoanSize, updateCreditScore, updatePropertyType, updateOccupancy,
         selectLoanSize, selectCreditScore, selectPropertyType, selectOccupancy,
         selectError, State } from './store';
...
export function LoanSizeInput(): JSX.Element {
    return (
        <NumberInput selector={selectLoanSize} action={updateLoanSize} label="Loan Size" />
    );
}

export function CreditScoreInput(): JSX.Element {
    return (
...
export function PropertyTypeInput(): JSX.Element {
    const options = [
...
export function OccupancyInput(): JSX.Element {
    const options = [
        ["Primary", "Primary"],
        ["Secondary", "Secondary"],
...
export function ErrorDisplay(): JSX.Element | null {
